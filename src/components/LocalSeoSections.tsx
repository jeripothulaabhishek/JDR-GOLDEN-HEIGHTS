...
const seoTabs: SeoTab[] = [
  {
    ...
    title: 'High-Growth Open Plots Near Yadadri Temple Corridor',
    icon: Landmark,
  ...
  },
  {
    ...
    title: '100% RERA Compliant & DTCP Approved Layouts',
    icon: Award,
    ...
    bullets: [
      'Approved layout parameters conforming to strict DTCP regulations.',
  ...
  {
    id: 'investment',
    label: 'Hyderabad to Yadadri Investment',
  ...
  },
  {
    ...
    bullets: [
      ...
      'Over 10% of total acreage dedicated to lush green parks and community recreation.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-serif font-bold text-white">
            Yadadri Investment <span className="text-gold-gradient">Intelligence</span>
          </h2>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-4 rounded-xl text-left border transition-all duration-300 ${
                    isActive
                      ? 'bg-gradient-to-r from-gold-600/25 to-gold-400/5 border-gold-400 text-white shadow-gold-glow'
                ...
                >
                  <span className="flex items-center text-xs sm:text-sm font-semibold uppercase tracking-wider">
                    <TabIcon className={`h-4.5 w-4.5 mr-3 ${isActive ? 'text-gold-400' : 'text-gray-500'}`} />
                    {tab.label}
                  </span>
                  <ChevronRight className={`h-4 w-4 transition-transform duration-300 ${isActive ? 'translate-x-1 text-gold-400' : 'text-gray-600'}`} />
                </button>
              );
            })}
          </div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  <div className="p-3 bg-gold-950/40 border border-gold-500/20 text-gold-400 rounded-xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-4 border-t border-white/5">
                  {currentTab.bullets.map((bullet, idx) => (
                    <div key={idx} className="flex items-start space-x-2.5">
                      <span className="p-0.5 bg-gold-950/40 border border-gold-500/30 text-gold-400 rounded-full mt-0.5 shrink-0">
